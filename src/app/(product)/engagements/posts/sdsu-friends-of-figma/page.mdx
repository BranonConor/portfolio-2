...
export const metadata = buildPageMetadata({
  ...
  description: "Speaking to design students at SDSU about careers in tech!",
  path: "/engagements/posts/sdsu-friends-of-figma",
});
...
<Video
  url="https://www.youtube.com/embed/MdwRX0MwtFE?si=WEJp_882XX2zWQVd"
  title="SDSU and Friends of Figma design panel"
/>
