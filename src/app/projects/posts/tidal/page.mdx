...
export const metadata = buildPageMetadata({
  ...
  description: "A comprehensive brand and website for a modern, SoCal Acupuncture clinic",
  path: "/projects/posts/tidal",
});
...
<ContentVideo
  url="/projects/tidal/website.mp4"
  caption="A walkthrough of the custom-built TIDAL Acupuncture website in light mode"
/>
<ContentVideo
  url="/projects/tidal/website-dark.mp4"
  caption="The same website in dark mode"
/>
