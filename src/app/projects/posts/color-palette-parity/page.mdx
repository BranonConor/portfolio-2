...
<HeaderImage image="/projects/color-palette-parity/cover.png" />

# Color Palette Parity @ Color Health

## Aligning system color palettes in design x code

<MetadataBar date="Dec 2022" category="Design Systems" />
...
<ContentImage
  ...
  caption="Person opening a Color essential health kit"
/>
...
Of course, things at scale are always more complicated than they may seem. For us here, we had to consider questions like:
