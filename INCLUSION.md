...
- **Product:** It's a web app that helps create and publish data-backed fully cited research papers with AI wrapped up in a social netowrk
- **Primary users:** Curious intellectual people looking for a break from traditional social media experiences which prey on dopamine
- **Known underserved users:** screen reader users, anyone speaking other languages, perhaps low vision users, people without gmail accounts, etc.
- **Distribution context:** in the web
- **Stakes:** those excluded from this site may lose out on opportunities to learn a lot of cool new things and engage in a community of like minded individuals
...
Conscious tradeoffs documented as part of this project's inclusion posture. These are not aspirations - they're current realities, surfaced so reviewers (human and AI) can flag when generated output assumes otherwise.

**Core assumptions**
- _Primary audience:_ I primarily build for iPhone users and desktop users who use Google Chrome and/or Safari, have good network speed, have english fluency and good patience to step through conversational flows with AI, and perhaps good AI literacy
- _Implicit defaults:_ My app assumes that those people can have very intellectually deep conversations in a chatbox with AI

**Authentication & access**
- _Methods supported:_ I support Google Oauth signin as well as email/username and password authentication/login
- _Known exclusion:_ ANyone who forgot their password :(
- _Reason for choice:_ It was the easiest to setup as a one-person team

**Information collection**
- _Information collected:_ usernames, passwords, emails, profile photos, etc.
- _Why it's required:_ Mostly to display profiles on social network features

**Interaction model**
- _Interaction modes:_ product is entirely text-based and there's no support for voice. It is probably a tad keyboard accessible but needs work, and it's touch-capable on mobile and tablest in the browser on a phone
- _Patterns not supported:_ Voice controls in the AI research chat

**Communication & language**
- _Languages supported:_ English only
- _Communication style:_ curious and verbose, as well as technical and plain languages

**Edge cases & intersections**
- _Known breakage scenarios:_ if someone is on low internet bandwidth, has difficulty with font sizes, can't type, etc.
- _Unexpected users:_ I think perhaps screen reader users, non-english speaking people, motor disabilities, etc.
